Pod::Spec.new do |s|
  ...
  s.platform         = :ios, '7.0'
  s.source           = { :git => "https://github.com/lerosua/CTAssetsPickerController.git" }
  ...
  #s.resource_bundles = { "CTAssetsPickerController" => ["Resources/CTAssetsPicker.xcassets", "Resources/*.lproj"] }
